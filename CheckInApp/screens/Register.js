...
export default class Register extends React.Component {
    ...
    async saveButton() {
        ...
        var valido = true;
        const fileUri = 'checkinapp/checkindata.json';
        let message = '';
        ...
        if (valido) {
            ...
            await FileSystem.writeToFile(fileUri, contents);
